...
exports.metrics = exports.strengthsAndWeaknesses = void 0;
exports.strengthsAndWeaknesses = `You are an expert code analyzer. You will be given the code file of a student who is new to the Python coding language.
				...
				`;
exports.metrics = `You are an expert code analyzer. You will be given the code file of a student who is new to the Python coding language.
